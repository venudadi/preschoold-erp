...
ALTER TABLE users ALTER COLUMN role TYPE VARCHAR(50) CHECK (role IN ('super_admin','owner','admin','academic_coordinator','teacher','parent','financial_manager')) NOT NULL;
