...
CREATE TABLE IF NOT EXISTS emergency_alerts (
    ...
    status VARCHAR(50) CHECK (role IN ('active', 'resolved', 'cancelled')) DEFAULT 'active',
...
CREATE TABLE IF NOT EXISTS emergency_procedures (
    ...
    required_frequency VARCHAR(50) CHECK (role IN ('weekly', 'monthly', 'quarterly', 'semi_annual', 'annual', 'as_needed')) DEFAULT 'as_needed',
...
CREATE TABLE IF NOT EXISTS emergency_drill_logs (
    ...
    drill_type VARCHAR(50) CHECK (role IN ('scheduled', 'surprise', 'actual_emergency')) NOT NULL,
    ...
    overall_rating VARCHAR(50) CHECK (role IN ('excellent', 'good', 'satisfactory', 'needs_improvement')) DEFAULT 'satisfactory',
