...
ALTER TABLE users
ADD COLUMN IF NOT EXISTS financial_authority_level ENUM('none', 'center', 'multi_center', 'corporate') DEFAULT 'none',
...
ADD COLUMN IF NOT EXISTS actual_approver_role ENUM('center_director', 'admin', 'financial_manager', 'owner', 'super_admin');
