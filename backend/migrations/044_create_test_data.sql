...
('test-center-1', 'Test Preschool Center', '123 Test Street, Test City', '555-0100', 'testcenter@preschool.com', TRUE)
...
('test-super-admin', 'superadmin', 'superadmin@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'super_admin', 'Test Super Admin', '555-0001', NULL, TRUE, TRUE, TRUE, FALSE),
('test-owner', 'owner', 'owner@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'owner', 'Test Owner', '555-0002', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-center-director', 'director', 'director@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'center_director', 'Test Center Director', '555-0003', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-admin', 'admin', 'admin@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'admin', 'Test Admin', '555-0004', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-financial-manager', 'finance', 'finance@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'financial_manager', 'Test Financial Manager', '555-0005', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-teacher-1', 'teacher1', 'teacher1@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'teacher', 'Test Teacher One', '555-0006', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-teacher-2', 'teacher2', 'teacher2@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'teacher', 'Test Teacher Two', '555-0007', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-parent-1', 'parent1', 'parent1@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'parent', 'Test Parent One', '555-0008', 'test-center-1', TRUE, TRUE, TRUE, FALSE),
('test-parent-2', 'parent2', 'parent2@test.com', '$2b$10$8K1p/pxGKwU2YvnZ8Hc.5uKjKnmZxR.G9tqZ3xX5nVzN8vYrZqX5y', 'parent', 'Test Parent Two', '555-0009', 'test-center-1', TRUE, TRUE, TRUE, FALSE)
...
('test-parent-rec-1', 'test-parent-1', 'Test', 'Parent One', 'parent1@test.com', '555-0008', 'Mother', TRUE),
('test-parent-rec-2', 'test-parent-2', 'Test', 'Parent Two', 'parent2@test.com', '555-0009', 'Father', TRUE)
...
('test-staff-1', 'test-teacher-1', 'EMP001', 'Test', 'Teacher One', 'teacher1@test.com', '555-0006', 'Lead Teacher', 'Education', '2023-01-01', 'test-center-1', TRUE),
('test-staff-2', 'test-teacher-2', 'EMP002', 'Test', 'Teacher Two', 'teacher2@test.com', '555-0007', 'Assistant Teacher', 'Education', '2023-02-01', 'test-center-1', TRUE),
('test-staff-3', 'test-admin', 'EMP003', 'Test', 'Admin', 'admin@test.com', '555-0004', 'Administrator', 'Administration', '2022-06-01', 'test-center-1', TRUE),
('test-staff-4', 'test-center-director', 'EMP004', 'Test', 'Center Director', 'director@test.com', '555-0003', 'Center Director', 'Management', '2022-01-01', 'test-center-1', TRUE),
('test-staff-5', 'test-financial-manager', 'EMP005', 'Test', 'Financial Manager', 'finance@test.com', '555-0005', 'Financial Manager', 'Finance', '2022-03-01', 'test-center-1', TRUE)
ON DUPLICATE KEY UPDATE user_id=VALUES(user_id);
...
SELECT '' AS '';
SELECT 'Super Admin: superadmin@test.com / superadmin' AS '';
SELECT 'Owner: owner@test.com / owner' AS '';
SELECT 'Center Director: director@test.com / director' AS '';
SELECT 'Admin: admin@test.com / admin' AS '';
SELECT 'Financial Manager: finance@test.com / finance' AS '';
SELECT 'Teacher 1: teacher1@test.com / teacher1' AS '';
SELECT 'Teacher 2: teacher2@test.com / teacher2' AS '';
SELECT 'Parent 1: parent1@test.com / parent1' AS '';
SELECT 'Parent 2: parent2@test.com / parent2' AS '';
SELECT '==============================================' AS '';