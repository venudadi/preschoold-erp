...
ADD COLUMN program_type ENUM('preschool', 'daycare') 
...
CREATE TABLE fee_components (
    ...
    component_type ENUM('one_time', 'recurring', 'annual') NOT NULL,
...
ADD COLUMN payment_frequency ENUM('Monthly', 'Quarterly', 'Annually') DEFAULT 'Monthly',
