...
/**
 * Modern Parent Dashboard with Floating Icon Navigation
 * Inspired by trendy, vibrant UI design
 */
const ModernParentDashboard = ({ user }) => {
            ...
            <Box>
              ...
              {selectedChild.first_name && (
                <Typography variant="body2" color="text.secondary">
                  Viewing {selectedChild.first_name}'s activities
                </Typography>
              )}
            </Box>
          </Box>
